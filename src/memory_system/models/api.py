...
class ProcessingResponse(BaseModel):
    ...
    original_type: MemoryType | None = Field(None, description="Original type if changed")
...
class CreateMemoryFromMessagePairRequest(BaseModel):
    ...
    previous_message: str | None = Field(None, description="Previous message content")
    speaker: str | None = Field(None, description="Current message speaker")
...
class MemoryResultItem(BaseModel):
    ...
    content: str = Field(..., description="Memory content")
    title: str | None = Field(None, description="Memory title")
