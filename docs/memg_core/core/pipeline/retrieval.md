...
- **Schema**:
  - Input: `memory_type` (String), `payload` (Dictionary or None), `include_details` (String), `projection` (Dictionary mapping String to List of Strings, or None)
  - Output: `dict[str, Any]` (Dictionary with Any type values)
  - Type Mixing: Defined types, with `payload` and `projection` allowing mixed types internally due to `Any`
...
- **Schema**:
  - Input: `dt` (Datetime Object or None)
  - Output: `str` (String)
  - Type Mixing: Defined type
...
- **Schema**:
  - Input: `days` (Integer or None)
  - Output: `datetime | None` (Datetime Object or None)
  - Type Mixing: Defined type
...
- **Schema**:
  - Input: `date_str` (Any type)
  - Output: `datetime` (Datetime Object)
  - Type Mixing: Mixed type (input `Any`)

### `_sort_key` (private)
- **Description**: Generates a stable sort key for SearchResult objects, ordering by score (descending), HRID index (ascending), then by ID (ascending).
- **Inputs**:
  - `r`: `memg_core.core.models.SearchResult` - The SearchResult object to generate a sort key for.
- **Returns**: `tuple` - A tuple suitable for sorting with the desired precedence.
- **Schema**:
  - Input: `SearchResult` (Pydantic Model)
  - Output: `tuple` (Tuple)
  - Type Mixing: Defined type
...
- **Inputs**:
  - `query`: `str | None` - The search query string (used for query param, not direct filter).
...
- **Schema**:
  - Input: `query` (String or None), `user_id` (String or None), `limit` (Integer), `relation_names` (List of Strings or None), `memo_type` (String or None), `modified_within_days` (Integer or None)
  - Output: `tuple[str, dict[str, Any]]` (Tuple of String and Dictionary with Any type values)
  - Type Mixing: Defined types, with dictionary allowing mixed types internally due to `Any`
...
- **Returns**: `list[memg_core.core.models.Memory]` - A list of `Memory` objects.
- **Schema**:
  - Input: `list[dict[str, Any]]` (List of Dictionaries with Any type values)
  - Output: `list[Memory]` (List of Pydantic Memory Models)
  - Type Mixing: Mixed type (input `Any`)
...
- **Schema**:
  - Input: `user_id` (String or None), `memo_type` (String or None), `modified_within_days` (Integer or None), `extra` (Dictionary with Any type values or None)
  - Output: `dict[str, Any]` (Dictionary with Any type values)
  - Type Mixing: Defined types, with dictionary allowing mixed types internally due to `Any`
...
- **Inputs**:
  ...
  - `candidates`: `list[memg_core.core.models.Memory]` - A list of `Memory` objects to be reranked.
  - `qdrant`: `memg_core.core.interfaces.qdrant.QdrantInterface` - An instance of the Qdrant interface.
  - `embedder`: `memg_core.core.interfaces.embedder.Embedder` - An instance of the Embedder for generating embeddings.
- **Returns**: `list[memg_core.core.models.SearchResult]` - A list of `SearchResult` objects, sorted by their new similarity scores.
- **Schema**:
  - Input: `query` (String), `candidates` (List of Memory Models), `qdrant` (QdrantInterface Object), `embedder` (Embedder Object)
...
- **Inputs**:
  - `seeds`: `list[memg_core.core.models.SearchResult]` - The initial list of `SearchResult` objects.
  - `kuzu`: `memg_core.core.interfaces.kuzu.KuzuInterface` - An instance of the Kuzu interface.
...
- **Returns**: `list[memg_core.core.models.SearchResult]` - An expanded and merged list of `SearchResult` objects.
- **Schema**:
  - Input: `seeds` (List of SearchResult Models), `kuzu` (KuzuInterface Object), `neighbor_limit` (Integer), `relation_names` (List of Strings or None)
  - Output: `list[SearchResult]` (List of Pydantic SearchResult Models)
  - Type Mixing: Defined types
...
- **Inputs**:
  ...
  - `qdrant`: `memg_core.core.interfaces.qdrant.QdrantInterface` - An instance of the Qdrant interface.
  - `kuzu`: `memg_core.core.interfaces.kuzu.KuzuInterface` - An instance of the Kuzu interface.
  - `embedder`: `memg_core.core.interfaces.embedder.Embedder` - An instance of the Embedder.
...
- **Returns**: `list[memg_core.core.models.SearchResult]` - A sorted list of `SearchResult` objects with deterministic HRID-based ordering.
- **Schema**:
  - Input: `query` (String or None), `user_id` (String), `limit` (Integer), `qdrant` (QdrantInterface Object), `kuzu` (KuzuInterface Object), `embedder` (Embedder Object), `filters` (Dictionary with Any type values or None), `relation_names` (List of Strings or None), `neighbor_cap` (Integer), `memo_type` (String or None), `modified_within_days` (Integer or None), `mode` (String or None), `include_details` (String), `projection` (Dictionary mapping String to List of Strings, or None)
  - Output: `list[SearchResult]` (List of Pydantic SearchResult Models)
